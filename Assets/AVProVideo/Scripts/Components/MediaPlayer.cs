...
namespace RenderHeads.Media.AVProVideo
{
	...
	public class MediaPlayer : MonoBehaviour
	{
		...
		private FileLocation _queueSubtitleLocation;

		[SerializeField]
		private string m_SubtitlePath;
		private string _queueSubtitlePath;
		...
		public bool EnableSubtitles(FileLocation fileLocation, string filePath)
		{
					...
					else
					{
						...
						try
						{
							...
							if (fullPath.Contains("://"))
							{
								...
								{
									Debug.LogError("[AVProVideo] Error loading subtitles '" + www.error + "' from " + fullPath);
								}
							}
							else
							{
			...
			{
				_queueSubtitleLocation = fileLocation;
				_queueSubtitlePath = filePath;
			}
		...
		public void DisableSubtitles()
		{
			...
			{
				_queueSubtitlePath = string.Empty;
			}
		}
		...
		void Update()
		{
			...
			{			
				...
				if (m_Subtitles != null && !string.IsNullOrEmpty(_queueSubtitlePath))
				{
					EnableSubtitles(_queueSubtitleLocation, _queueSubtitlePath);
					_queueSubtitlePath = string.Empty;
				}
